...
//                r = (Triangle) figures.get(i);
//                if (checkTriangleSides(r)) {
...
//    }
//
//    private static boolean checkTriangleSides(Triangle r) {
//        return r.getA() == r.getB() && r.getB() == r.getC();
//    }
//
//}