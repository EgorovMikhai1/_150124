package module_3.lecture_4.javaTasksExamples;
...
//        System.out.println(matches.stream().filter(x -> x.getStadium().contains("NULL")).count());
        ...
        // можно посчитать примерную скорость работы 396708 542542 974667 1601625 588167
...
//
        ...
        // можно посчитать примерную скорость работы 3338084 3312000 4010917 3878709 3885750
//        long start = System.nanoTime();
